...
export const generateImageTool = tool({
  description: 'Generate 6 plan-driven creative variations for a Meta ad. Use after a CreativePlan is available. Variations can include: people/no-people, product/service focus, and text densities up to text-only. Always respect safe zones and produce both square and vertical; vertical reuses the same base image with extended canvas (blur/gradient/solid) and reflowed overlays. No brand logos/colors.',
