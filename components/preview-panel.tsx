...
import { BarChart3, Play, Target, DollarSign, Flag, Eye, ImageIcon, Video, Layers, Sparkles } from "lucide-react"
...
export function PreviewPanel({}: PreviewPanelProps) {
  ...
  return (
    <div className="flex h-full flex-col relative">
      <div className="flex h-12 items-center justify-between px-4 bg-panel-header text-panel-header-foreground border-b border-border">
