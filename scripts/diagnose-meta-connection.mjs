 ...
 * 
 * Usage: node scripts/diagnose-meta-connection.mjs YOUR_CAMPAIGN_ID
 */
...
if (!campaignId) {
  ...
  console.error('Usage: node scripts/diagnose-meta-connection.mjs YOUR_CAMPAIGN_ID')
  process.exit(1)
}
...
async function diagnose() {
  ...
  const apiResponse = {
    ...
    status: state?.meta_connect_data?.status || 'disconnected',
  }
